...
INSERT INTO credit_account(account_number, principal_debt, interest_debt, is_active, opening_date, closing_date,
                           currency_code)
VALUES ('10000000000000000002', 980000.00, 39010.00, true, '10.01.2022', '10.01.2025', 'RUB');
...
VALUES ('0799f8b8-729d-4818-b1ba-5e64f88f6d03', 4, 'APPROVED_BY_BANK', 900000.00, 6, '01.01.2022', 100000.00, 50000.00,
        '123456789012');
...
VALUES (5, 'CONSUMER_CREDIT', 900000.00, 'RUB', 0.15, true, 0, 'ACTIVE', '10000000000000000001');

INSERT INTO credit_agreement(id, agreement_date, termination_date, responsible_specialist_id, is_active)
